  ...
  return (
    <html lang="en" className={inter.variable}>
      ...
      <body className="min-h-screen font-sans antialiased touch-manipulation">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:z-[100] focus:top-4 focus:left-4 focus:rounded-md focus:bg-primary focus:px-4 focus:py-2 focus:text-primary-foreground focus:shadow-lg"
        >
          Skip to content
        </a>
