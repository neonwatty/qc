...
export function ReflectionForm({ sessionId }: ReflectionFormProps): React.ReactNode {
  const { reflection, isReflectionModalOpen, closeReflectionModal, saveReflection } = useBookends()
          ...
          <div className="space-y-6 mt-4">
            ...
            <div>
              ...
              <Textarea
                ...
                maxLength={300}
              />
              <p className="text-xs text-gray-500 mt-1">{keyTakeaway.length}/300 characters</p>
            </div>
            ...
            <Card className="p-4 bg-gray-50">
              ...
              <p className="text-xs text-gray-600 mt-2">
                {shareWithPartner
                  ? 'Your partner will be able to see your reflection after they complete theirs'
