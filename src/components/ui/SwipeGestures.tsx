      ...
      <AnimatePresence>
        {visibleCards.map((card, index) => (
          <motion.div
            ...
            initial={{ scale: 1 - index * 0.05, y: index * 8, opacity: 1 - index * 0.2 }}
            animate={{ scale: 1 - index * 0.05, y: index * 8, opacity: 1 - index * 0.2 }}
            exit={{ x: exitDirection === 'left' ? -300 : 300, opacity: 0, transition: { duration: 0.3 } }}
