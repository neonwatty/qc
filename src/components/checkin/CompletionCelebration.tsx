...
function SessionStats({ show, topicCount, timeSpent, actionItemsCount }: SessionStatsProps): React.ReactNode {
  return (
    <AnimatePresence>
      {show && (
        <motion.div
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              <div className="text-2xl font-bold text-purple-600">{topicCount}</div>
...
function CelebrationContent({
  ...
  onGoHome,
  onStartNew,
}: CelebrationContentProps): React.ReactNode {
